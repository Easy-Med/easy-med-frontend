...
function VisitTile({ visit, ...props }) {
  ...
  const completeVisitMutation = useMutation(
    () => ReservedVisitsService.completeVisit(visit.id),
    {
      onSuccess: () => queryClient.invalidateQuery(`${role}Visits`),
    }
  );
    ...
    <Box>
      ...
      >
        ...
        >
          ...
          >
            <Box>
              <VisitDetailsField type="pesel">
                {visit.patient.personalIdentityNumber}
              </VisitDetailsField>
              <VisitDetailsField type="e-mail">
                {visit.patient.emailAddress}
              </VisitDetailsField>
              <VisitDetailsField type="telephone">
                {visit.patient.telephoneNumber}
              </VisitDetailsField>
            </Box>
            <Box>
              <VisitDetailsField type="date">
                {moment(visit.startDate).format("DD.MM.YYYY HH:mm")}
              </VisitDetailsField>
              <VisitDetailsField type="location">
                {visit.location}
              </VisitDetailsField>
            </Box>
          </Box>
